...
namespace CourseWebApi.Models
{
    ...
    public class EmailParams
    {
        ...
        public static EmailParams GetEmailParamsNew(ref GolflerEntities Db, string TemplateName, ref IQueryable<GF_EmailTemplatesFields> templateFields, long courseId, string logintype, ref string mailresult, bool IsSuperAdminToUse)
        {
            ...
            try
            {
                ...
                if (courseDetails != null) // Course Details
                {
                    ...
                    // param.CourseLoginUrl = ConfigClass.SiteUrl + "Golfler/courseadmin";
                ...
                else
                {
                    if (courseId == 0)  // Super Admin OR Golfer
                    {
                        ...
                        //  {
                        //   param.CourseLoginUrl = ConfigClass.SiteUrl + "Golfler";
                        //   }
                        //  else // Golfer
                        //  {
                        //  param.CourseLoginUrl = ConfigClass.SiteUrl + "Golfler/golfer";
                        //  }
                    }
                ...
                if (mailresult == "")
                {
                    ...
                    else if (IsSuperAdminToUse)
                    {
                        smtpSettings = Db.GF_SMTPSettings.FirstOrDefault(x => x.CourseID == 0);
    ...
    public class MailClass
    {
        ...
        private static bool SendMail(MailMessage mess, string smtpHost, string smtpUserName, string smtpPassword, int smtpPort, bool EnableSsl, ref string mailresult)
        {
            ...
            //    try
            //    {
            //        string strMsg = "Mail has been successfully sent for: " + mess.To ;
            ...
            //    try
            //    {
            //        string strMsg = "Mail sending failure for: " + mess.To ;
            //        throw new FormatException(strMsg);
            //    }
            //    catch (Exception ex)
            //    {
        ...
        public static bool SendMail(EmailParams param, ref string mailresult)
        {
            try
            {
                ...
                //message = addEmailAddress(message, "amitkumar@cogniter.com", "cc");
