...
namespace Golfler.Models
{
    public class LogClass
    {
        ...
        /// <returns></returns>
        public static string MassMessageLog(List<string> msgs,string strfilename="")
        {
            string strResult = "";
            try
            {
                ...
                RequestFilePath = Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["PhysicalApplicationPath"]) + Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["ERROR_LOG_DIR"]);
                if (RequestLogMode)
                {
                    string fileName = "";
                    if (strfilename == "")
                    {
                        fileName = "MassMessage.txt";
                    }
                    else
                    {
                        fileName = "ReminderMails.txt";
                    }
