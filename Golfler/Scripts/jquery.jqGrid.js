...
(function ($) {
    ...
    $.fn.jqGrid = function (pin) {
		...
		isMSIE = $.jgrid.msie;
            ...
            $("<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'><img src='/Content/Images/Admin/loading-bars.gif' alt=''/></div>").insertBefore(gv);
    ...
    $.jgrid.extend({
        ...
        navGrid: function (elem, o, pEdit, pAdd, pDel, pSearch, pView) {
			...
			onHoverOut = function () {
				...
				sep = "<td class='ui-pg-button ui-state-disabled' style='width:4px;display:none'><span class='ui-separator'></span></td>",
				pgid, elemids;
                    if (i === 0) {
                        pgid = elem;
                        elemids = $t.p.id;
                    ...
                    if (o.edit) {
                        tbd = $("<td class='ui-pg-button ui-corner-all' style='display:none;'></td>");
                        pEdit = pEdit || {};
