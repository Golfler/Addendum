    ...
    b.extend(b.jgrid, {
            ...
            from: function (f) {
                return new function (d, c) {
                    ...
                    this._compare = function (a, b, e) {
                        ...
                        !i &&
                        ("number" !== typeof a && ("number" !== typeof b && (a = "" + a, b = "" + b)));
                    ...
                    this._getOrder = function (a, c, f, d, h) {
                        ...
                        void 0 === d && (d = "text");
                        s =
                        "float" == d || ("number" == d || ("currency" == d || "numeric" == d)) ? function (a) {
                    ...
                    this._compareValues = function (a, c, d, f, i) {
                        var h;
                        h = E ? "jQuery.jgrid.getAccessor(this,'" + c + "')" :
                        "this";
                        void 0 === d && (d = null);
                        var g = d,
                        ...
                        if (null !== d) switch (k) {
                            ...
                            default:
                                h =
                            e._getStr(h), g = e._getStr('"' + e._toStr(g) + '"')
                        }
                        e._append(h + " " + f + " " + g);
                        e._setCommand(a, c);
                        e._resetNegate();
                ...
                if (!this.grid) {
                        ...
                        populateVisible: function () {
                            ...
                            if (a) {
                                ...
                                if (d[0].rows.length) try {
                                    L = (f =
                                        d[0].rows[1]) ? b(f).outerHeight() || c.prevRowHeight : c.prevRowHeight
                                } catch (h) {
                                    L = c.prevRowHeight
                                }
                                if (L) {
                                    ...
                                    if (F && (!e.lastpage || !(y > e.lastpage || (1 == e.lastpage ||
                                        y === e.page && y === e.lastpage)))) c.hDiv.loading ? c.timer = setTimeout(c.populateVisible, e.scrollTimeout) : (e.page = y, q && (c.selectionPreserver(d[0]), c.emptyRows.call(d[0], !1, !1)), c.populate(F))
                                }
                            }
                        },
                    ...
                    if ("TABLE" != this.tagName.toUpperCase()) alert("Element is not a table");
                        ...
                        if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                            ...
                            this.id + "'><img src='/Content/Images/Admin/loading-bars.gif' alt=''/></div>").insertBefore(j);
                            b(this).attr({
                                cellspacing: "0",
                                cellpadding: "0",
                                border: "0",
                            ...
                            var n = function (a, b) {
                                ...
                                if (e === 0) y = y + ("width: " + c.headers[d].width + "px;");
                                    ...
                                    if ((d =
                                        P.cellattr.call(a, g, f, h, P, j)) && typeof d === "string") {
                                ...
                                if (b.isXMLDoc(c)) {
                                    ...
                                    (c = b.jgrid.getXmlData(c, j.row, true)) ||
                                        (c = []);
                                    var R = c.length,
                                        r = 0,
                                        z = [],
                                ...
                                if (c) {
                                    ...
                                    var J = b.isFunction(a.p.afterInsertRow),
                                        ...
                                        N;
                                    if (a.p.grouping) {
                                        M = a.p.groupingView.groupCollapse ===
                                            true;
                                    ...
                                    if (a.p.gridview === true) {
                                        B =
                                            a.p.treeANode > -1 ? a.p.treeANode : 0;
                                ...
                                if (b.isArray(a.p.data)) {
                                    ...
                                    b.each(a.p.colModel, function () {
                                        ...
                                        if (j == "date" || j == "datetime") {
                                            if (this.formatter && (typeof this.formatter === "string" && this.formatter == "date")) {
                                                ...
                                                k = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat :
                                    ...
                                    if (a.p.treeGrid) b(a).jqGrid("SortTree", d, a.p.sortorder, f[d].stype, f[d].srcfmt);
                                        ...
                                        if (a.p.grouping)
                                            for (o =
                                                0; o < q; o++) u.orderBy(h[o], l.groupOrder[o], g[o].stype, g[o].srcfmt);
                                                ...
                                                case "script":
                                                    b.ajax(b.extend({
                                                        ...
                                                        success: function (e, g, h) {
                                                            ...
                                                            a.p.beforeProcessing.call(a, e, g, h) === false) O();
                                                            else {
                                                        ...
                                                        beforeSend: function (c, e) {
                                                            var d = true;
                                                            b.isFunction(a.p.loadBeforeSend) && (d = a.p.loadBeforeSend.call(a,
                                                            c, e));
                                                            d === void 0 && (d = true);
                                ...
                                if (a.p.frozenColumns && a.p.id + "_frozen") b("#cb_" +
                                    b.jgrid.jqID(a.p.id), a.grid.fhDiv)[a.p.useProp ? "prop" : "attr"]("checked", c)
                            }, ka = function (c, d) {
                                if (c.indexOf("sublist") < 0) {
                                    var e = "",
                                    ...
                                    b(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" +
                                ...
                                if (a.p.colModel[d].sortable && !(a.p.savedRow.length > 0)) {
                                    ...
                                    if (b(a).triggerHandler("jqGridSortCol", [c, d, e]) === "stop") a.p.lastsort = d;
                                        ...
                                        a.p.onSortCol.call(a, c, d, e) == "stop") a.p.lastsort = d;
                                    else {
                            ...
                            if (this.p.multiselect) {
                                ...
                                b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
                                    ...
                                    if (this.checked) {
                                        ...
                                        b(a.rows).each(function (d) {
                                            if (d > 0 && (!b(this).hasClass("ui-subgrid") && !b(this).hasClass("ui-state-disabled"))) {
                                                ...
                                                "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop" : "attr"]("checked", false);
                                    ...
                                    b.isFunction(a.p.onSelectAll) && a.p.onSelectAll.call(a,
                                    Z ? a.p.selarrrow : ga, Z)
                                })
                            ...
                            (function () {
                                ...
                                if (a.p.shrinkToFit === true && f > 0) {
                                    ...
                                    q = 0;
                                    k ? c.width - m - (d + e * f) !== h && (q = c.width - m - (d + e * f) - h) : !k && (Math.abs(c.width -
                                    m - (d + e * f)) !== 1 && (q = c.width - m - (d + e * f)));
                            ...
                            S = "";
                            a.p.footerrow && (S += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='ui-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='ui-widget-content footrow footrow-" +
                            g + "'>");
                            var j = b("tr:first", z),
                            ...
                            j = b("<table class='ui-jqgrid-htable' style='width:" +
                                a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(z),
                            ...
                            b(a).before(c.hDiv).click(function (c) {
                                ...
                                if (!(A.tagName == "A" || (A.tagName == "INPUT" || (A.tagName == "TEXTAREA" || (A.tagName == "OPTION" ||
                                A.tagName == "SELECT"))) && !d) && e === true) {
                                    r = p[0].id;
                                        ...
                                        if (a.p.multiselect && (a.p.multiboxonly && !d)) {
                                            ...
                                            b(a.p.selarrrow).each(function (c, d) {
                                                ...
                                                if (g) {
                                                    ...
                                                    b("#jqg_" + b.jgrid.jqID(a.p.id) +
                                                        "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(g))[a.p.useProp ? "prop" : "attr"]("checked", false)
                                                }
                                            });
                                            a.p.selarrrow = []
                                        }
                                ...
                                if (b(p).length !== 0) {
                                    r = p[0].rowIndex;
                                    J = b.jgrid.getCellIndex(A);
                                    b(a).triggerHandler("jqGridDblClickRow", [b(p).attr("id"),
                                    r, J, c
                                ]);
                            ...
                            "tb_" + this.id).insertAfter(c.hDiv), D && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("ui-userdata ui-state-default").attr("id", "t_" + this.id), D && b(c.uDiv).hide());
                            ...
                            a.p.footerrow && (c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0], d = b("<div class='ui-jqgrid-hbox" +
                            ("rtl" == g ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(d).width(c.width).insertAfter(c.hDiv), b(d).append(S), c.footers = b(".ui-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "ui-state-default jqgrid-rownum"), D && b(c.sDiv).hide());
                            d = null;
                            if (a.p.caption) {
                                var qa = a.p.datatype;
        ...
        b.jgrid.extend({
            ...
            d, c) {
                return this.each(function () {
                    var e, a, i, h, g, j;
                    if (void 0 !== f && (d = !1 === d ? !1 : !0, (a = this.rows.namedItem("" + f)) && (a.className && !(-1 < a.className.indexOf("ui-state-disabled"))))) (!0 === this.p.scrollrows && (i = this.rows.namedItem(f).rowIndex, 0 <= i && (e = b(this.grid.bDiv)[0].clientHeight, h = b(this.grid.bDiv)[0].scrollTop, g = b(this.rows[i]).position().top, i = this.rows[i].clientHeight, g + i >= e + h ? b(this.grid.bDiv)[0].scrollTop = g - (e + h) + i + h : g < e + h && (g < h && (b(this.grid.bDiv)[0].scrollTop = g)))), !0 === this.p.frozenColumns &&
                    (j = this.p.id + "_frozen"), this.p.multiselect) ? (this.setHeadCheckBox(!1), this.p.selrow = a.id, h = b.inArray(this.p.selrow, this.p.selarrrow), -1 === h ? ("ui-subgrid" !== a.className && b(a).addClass("ui-state-highlight").attr("aria-selected", "true"), e = !0, this.p.selarrrow.push(this.p.selrow)) : ("ui-subgrid" !== a.className && b(a).removeClass("ui-state-highlight").attr("aria-selected", "false"), e = !1, this.p.selarrrow.splice(h, 1), g = this.p.selarrrow[0], this.p.selrow = void 0 === g ? null : g), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" +
                    b.jgrid.jqID(a.id))[this.p.useProp ? "prop" : "attr"]("checked", e), j && (-1 === h ? b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).addClass("ui-state-highlight") : b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j))[this.p.useProp ? "prop" : "attr"]("checked", e)), b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && (d && this.p.onSelectRow.call(this, a.id, e, c))) : "ui-subgrid" !== a.className && (this.p.selrow !=
                    a.id ? (b(this.rows.namedItem(this.p.selrow)).removeClass("ui-state-highlight").attr({
                        "aria-selected": "false",
                        tabindex: "-1"
                    }), b(a).addClass("ui-state-highlight").attr({
                        "aria-selected": "true",
                        tabindex: "0"
                    }), j && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(j)).removeClass("ui-state-highlight"), b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(j)).addClass("ui-state-highlight")), e = !0) : e = !1, this.p.selrow = a.id, b(this).triggerHandler("jqGridSelectRow", [a.id, e, c]), this.p.onSelectRow && (d && this.p.onSelectRow.call(this,
                        a.id, e, c)))
                })
            },
            resetSelection: function (f) {
                return this.each(function () {
                    ...
                    if (void 0 !== f) {
                        ...
                        a && (b("#" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(a)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(d.p.id) +
                        "_" + b.jgrid.jqID(f), "#" + b.jgrid.jqID(a))[d.p.useProp ? "prop" : "attr"]("checked", !1))
                    ...
                    !0 === d.p.cellEdit && (0 <= parseInt(d.p.iCol, 10) && (0 <= parseInt(d.p.iRow, 10) && (b("td:eq(" + d.p.iCol + ")", d.rows[d.p.iRow]).removeClass("edit-cell ui-state-highlight"),
                    b(d.rows[d.p.iRow]).removeClass("selected-row ui-state-hover"))));
                    d.p.savedRow = []
                })
            },
                ...
                this.each(function () {
                    ...
                    if (d) try {
                        if (b(this.p.colModel).each(function (a) {
                            ...
                            m;
                            if (h.p.treeGrid)
                                for (m in h.p.treeReader) h.p.treeReader.hasOwnProperty(m) &&
                                delete l[h.p.treeReader[m]];
            ...
            addRowData: function (f, d, c, e) {
                ...
                d && (b.isArray(d) ? (v = !0, c = "last", E = f) : (d = [d], v = !1), this.each(function () {
                    ...
                    for (var M = 0, X = "", H = {}, V = b.isFunction(this.p.afterInsertRow) ? true : false; M < W; ) {
                        ...
                        h.unshift(this.constructTr(f, false, X, H,
                        K, false));
                        h[h.length] = "</tr>";
                        ...
                        this.p.subGrid ===
                        true && b(this).jqGrid("addSubGrid", g + k, l);
                        this.p.records++;
                        this.p.reccount++;
            ...
            footerData: function (f, d, c) {
                ...
                this.each(function () {
                    ...
                    b(this.p.colModel).each(function (e) {
                        ...
                        } : {}, b("tr.footrow td:eq(" + e + ")", j.grid.sDiv).html(k).attr(g),
                        i = !0) : "get" == f && (h[a] = b("tr.footrow td:eq(" + e + ")", j.grid.sDiv).html())
                    })
                });
                return "get" == f ? h : i
            },
            showHideCol: function (f, d) {
                return this.each(function () {
                    ...
                    if (c.grid) {
                        ...
                        !0 === e && (!0 === c.p.shrinkToFit && (!isNaN(c.p.height) &&
                        (c.p.tblwidth += parseInt(c.p.scrollOffset, 10))), b(c).jqGrid("setGridWidth", !0 === c.p.shrinkToFit ? c.p.tblwidth : c.p.width));
            ...
            remapColumns: function (f, d, c) {
                ...
                i.p.lastsort = b.inArray(i.p.lastsort,
                f);
                    ...
                    if (this.grid) {
                        ...
                        if (!isNaN(f)) {
                            ...
                            if (!0 === d) {
                                ...
                                m = 0;
                                j ? f -
                                n - (a + i * g) !== k && (m = f - n - (a + i * g) - k) : 1 !== Math.abs(f - n - (a + i * g)) && (m = f - n - (a + i * g));
                ...
                return this.each(function () {
                    ...
                    if (this.grid && (isNaN(d) ? b(this.p.colModel).each(function (a) {
                        ...
                        if ("" !== c || !0 === i) g = this.formatter(f, c, h, g, "edit"), j = this.p.colModel[h].title ? {
                            title: b.jgrid.stripHtml(g)
                        } : {}, this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(g).attr(j) : b(k).html(g).attr(j), "local" == this.p.datatype && (g = this.p.colModel[h], c = g.formatter &&
                        ("string" === typeof g.formatter && "date" == g.formatter) ? b.unformat.date.call(this, c, g) : c, j = this.p._index[f], void 0 !== j && (this.p.data[j][g.name] = c));
            ...
            clearGridData: function (f) {
                return this.each(function () {
                    if (this.grid) {
                        ...
                        if (this.p.deepempty) b("#" + b.jgrid.jqID(this.p.id) +
                    ...
                    b(c).keydown(function (e) {
                        ...
                        if (a)
                            if (g = c.p._index[a.id], 37 === e.keyCode || (38 === e.keyCode || (39 === e.keyCode || 40 === e.keyCode))) {
                                ...
                                37 === e.keyCode && (c.p.treeGrid && (c.p.data[g][j] && b(a).find("div.treeclick").trigger("click")),
                                b(c).triggerHandler("jqGridKeyLeft", [c.p.selrow]), b.isFunction(d.onLeftKey) && d.onLeftKey.call(c, c.p.selrow));
                            ...
                            } else 13 === e.keyCode ? (b(c).triggerHandler("jqGridKeyEnter", [c.p.selrow]), b.isFunction(d.onEnter) && d.onEnter.call(c, c.p.selrow)) : 32 === e.keyCode && (b(c).triggerHandler("jqGridKeySpace", [c.p.selrow]),
                            b.isFunction(d.onSpace) && d.onSpace.call(c, c.p.selrow))
                    })
                })
            },
            unbindKeys: function () {
    ...
    (function (a) {
        ...
        a.fmatter.util = {
            ...
            DateFormat: function (c, b, d, e) {
                ...
                e.masks.hasOwnProperty(d) ?
                d = e.masks[d] : d || (d = "Y-m-d");
                c = i.getHours();
                b = i.getMinutes();
                g = i.getDate();
                h = i.getMonth() + 1;
    ...
    (function (a) {
        a.extend(a.jgrid, {
            ...
            createModal: function (d, b, c, e, g, h, f) {
                ...
                b = {};
                if (a.fn.jqm && !0 === c.jqModal) 0 === c.left && (0 === c.top && (c.overlay && (f = [], f = a.jgrid.findPos(g), c.left = f[0] + 4, c.top = f[1] + 4))), b.top = c.top + "px",
            b.left = c.left;
...
-1 === a.inArray(b, e) && a(d).attr(b, c)
            ...
            checkValues: function (d, b, c, e, g) {
                ...
                if (h) {
                    ...
                    if (void 0 !== h.minValue &&
                    (!isNaN(h.minValue) && parseFloat(d) < parseFloat(h.minValue))) return [!1, f + ": " + a.jgrid.edit.msg.minValue + " " + h.minValue, ""];
    ...
    (function (a) {
        ...
        a.jgrid.extend({
                ...
                return this.each(function () {
                    ...
                    if (e.grid) {
                        ...
                        if (void 0 !== a("#" + a.jgrid.jqID(t.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                            ...
                            b.gbox = "#gbox_" + h;
                            b.layer ?
                            a.jgrid.createModal(t, p, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                                position: "relative"
                    ...
                    function h(c, e, k, j) {
                        ...
                        a(e.p.colModel).each(function (n) {
                            ...
                            if ("cb" !== i && ("subgrid" !== i && (!0 === this.editable && "rn" !== i))) {
                                ...
                                o = a.jgrid.createEl.call(d, this.edittype, r, h, !1,
                    ...
                    viewGridRow: function (u, c) {
                        ...
                        g, i;
                                if (i = a(c).jqGrid("getInd", b, !0)) a("td", i).each(function (b) {
                                    ...
                                    "cb" !== d && ("subgrid" !== d && ("rn" !== d && (g = d == c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), a.extend({}, c.p.colModel[b].editoptions || {}), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + m).html(g), e && a("#" + d, "#" +
                            m).parents("tr:first").hide(), f++)))
                                }), 0 < f && a("#id_g", "#" + m).val(b)
                            }
                            ...
                            function t(b, c) {
                                ...
                                b == d ? a("#nData", "#" + m + "_2").addClass("ui-state-disabled") : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("ui-state-disabled") ? a("#nData", m +
                        "_2").addClass("ui-state-disabled") : a("#nData", "#" + m + "_2").removeClass("ui-state-disabled")
                            }
            ...
            c) {
                            ...
                            c.cancelicon[2] + "'></span>");
                                ...
                                g, h = a("#DelData>td", "#" + i).text();
                                    ...
                                    (h[g] = a.jgrid.stripPref(e.p.idPrefix, h[g]));
                                            ...
                                            (f = b[e.p.id].afterSubmit.call(e, d, m)); if (f[0] === false) {
                        ...
                        i;
                            ...
                            w, d = function () {
                                ...
                                o, l;
                                        ...
                                        c.add && (h = h || {}, i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon +
                                "'></span>" + c.addtext + "</div>"), a("tr", g).append(i), a(i, g).attr({
                                    title: c.addtitle || "",
                                    id: h.id || "add_" + l
                                }).click(function () {
                                    ...
                                    return false
                                        ...
                                        c.view && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), r = r || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr",
                                g).append(i), a(i, g).attr({
                                    title: c.viewtitle || "",
                                    id: r.id || "view_" + l
                                }).click(function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                    ...
                                    return false
                                        ...
                                        c.del && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), s = s || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon +
                                "'></span>" + c.deltext + "</div>"), a("tr", g).append(i), a(i, g).attr({
                                    title: c.deltitle || "",
                                    id: s.id || "del_" + l
                                }).click(function () {
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (f.p.multiselect) {
                                            b = f.p.selarrrow;
                                            b.length === 0 && (b = null)
                                        } else b = f.p.selrow; if (b) a.isFunction(c.delfunc) ? c.delfunc.call(f, b) : a(f).jqGrid("delGridRow", b, s);
                                        else {
                                            a.jgrid.viewModal("#" + p.themodal, {
                                                gbox: "#gbox_" + a.jgrid.jqID(f.p.id),
                                                jqm: true
                                ...
                                a("tr", g).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>");
                                        c.search && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), t = t || {}, a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", g).append(i), a(i, g).attr({
                                            ...
                                            a(this).hasClass("ui-state-disabled") || (a.isFunction(c.searchfunc) ? c.searchfunc.call(f, t) : a(f).jqGrid("searchGrid",
                                    t));
                                            return false
                    ...
                    navButtonAdd: function (b, c) {
                        ...
                        h = this;
                                if (e && !(c.id && void 0 !== a("#" + a.jgrid.jqID(c.id), e)[0])) {
                                    ...
                                    "first" == c.position ? 0 === e.rows[0].cells.length ? a("tr", e).append(s) : a("tr td:eq(0)", e).before(s) : a("tr",
                            e).append(s);
                    ...
                    h;
                            if (e.grid) {
                                ...
                                if (s)
                                    for (h in s) s.hasOwnProperty(h) && (a("[name=" + a.jgrid.jqID(h) + "]", c).is("input:radio") ||
                            a("[name=" + a.jgrid.jqID(h) + "]", c).is("input:checkbox") ? a("[name=" + a.jgrid.jqID(h) + "]", c).each(function () {
                    ...
                    FormToGrid: function (b, c, e, h) {
                        ...
                        t = {};
                                ...
                                "add" == e ? a(this).jqGrid("addRowData", b, t, h) :
                    ...
                    f, t = /msie/i.test(navigator.userAgent) && !window.opera;
                            ...
                            k.searchrules(g, k);
                                ...
                                this.reDraw = function () {
                                    ...
                                    a(this).append(g);
                                    a.isFunction(this.p.afterRedraw) && this.p.afterRedraw.call(this,
                            this.p)
                                };
            ...
            (function (a) {
                ...
                (f.successfunc = c), void 0 !== e && (f.url = e), void 0 !== o && (f.extraparam = o), a.isFunction(l) && (f.aftersavefunc = l), a.isFunction(g) && (f.errorfunc = g), a.isFunction(n)) f.afterrestorefunc = n;
                        var f = a.extend(!0, {
                            successfunc: null,
                            url: null,
                            extraparam: {},
                ...
                m, h = {}, w = {}, r = {}, t, s, q;
                    ...
                    i = !1 === d.p.keyIndex ? p.id : d.p.colModel[d.p.keyIndex + (!0 === d.p.rownumbers ? 1 : 0) + (!0 === d.p.multiselect ? 1 : 0) + (!0 === d.p.subGrid ? 1 : 0)].name;
                            if (h) {
                                h[p.oper] = p.editoper;
                                if (void 0 === h[i]) h[i] = b;
                                else if (q.id !== d.p.idPrefix + h[i] && (p = a.jgrid.stripPref(d.p.idPrefix, b), void 0 !== d.p._index[p] && (d.p._index[h[i]] =
                        d.p._index[p], delete d.p._index[p]), b = d.p.idPrefix + h[i], a(q).attr("id", b), d.p.selrow === u && (d.p.selrow = b), a.isArray(d.p.selarrrow) && (p = a.inArray(u, d.p.selarrrow), 0 <= p && (d.p.selarrrow[p] = b)), d.p.multiselect)) p = "jqg_" + d.p.id + "_" + b, a("input.cbox", q).attr("id", p).attr("name", p);
                        ...
                        b, h);
                                ...
                                error: function (c, e, g) {
                                    ...
                                    if (a.isFunction(f.errorfunc)) f.errorfunc.call(d,
                            b, c, e, g);
                                    else {
                ...
                o = {};
                    ...
                    addRow: function (b) {
                        ...
                        return this.each(function () {
                            if (this.grid) {
                                var c = this;
                                b.rowID = a.isFunction(b.rowID) ? b.rowID.call(c, b) : null !=
                        b.rowID ? b.rowID : a.jgrid.randId();
                        ...
                        o, l = a.jgrid.jqID(e.p.id);
                            ...
                            "Cancel row editing",
                                ...
                                !0 === c.restoreAfterSelect && (o = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow : !1, e.p.beforeSelectRow = function (b, f) {
                                    var g = true;
                                    if (e.p.savedRow.length > 0 && (e.p._inlinenav ===
                            true && (b !== e.p.selrow && e.p.selrow !== null))) {
                            ...
                            j = b.jgrid.jqID(k);
                                    ...
                                    if (h !== a.p.savedRow[c].v) {
                                        ...
                                        if (!0 === p[0]) {
                                            ...
                                            b.isFunction(a.p.beforeSubmitCell) && ((c = a.p.beforeSubmitCell.call(a, a.rows[d].id, k, e,
                                    d, f)) || (c = {}));
        ...
        g, f, h = function (a,
            ...
            h) {
                    ...
                    h, e, i, g = [];
                        ...
                        g = this.p.treeReader.right_field;
                                                if (!a[c]) {
                                                    var f = d.jgrid.getAccessor(a,
                            this.p.localReader.id),
                            l = d("#" + d.jgrid.jqID(f), this.grid.bDiv)[0],
                            k = this.p._index[f];
                                                    d(this).jqGrid("isNodeLoaded", this.p.data[k]) ? (a[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus")) : this.grid.hDiv.loading || (a[c] = !0, d("div.treeclick", l).removeClass(this.p.treeIcons.plus + " tree-plus").addClass(this.p.treeIcons.minus + " tree-minus"), this.p.treeANode = l.rowIndex, this.p.datatype = this.p.treedatatype, "nested" == this.p.treeGridModel ?
            ...
            d = d + l;
                    ...
                    i.charAt(0) ? d += " " + i.substr(1) + '="' + a[i].toString() + '"' : f = !0);
                                                d += f ? ">" : "/>";
                                                if (f) {
                                                    for (i in a) a.hasOwnProperty(i) && ("#text" === i ? d += a[i] : "#cdata" === i ? d += "<![CDATA[" + a[i] + "]]\x3e" : "@" !== i.charAt(0) && (d += g(a[i], i, e + "\t")));
            ...
            ((b && ":") + '"' + a.replace(/\\/g, "\\\\").replace(/\"/g, '\\"') + '"') : e + ((b && ":") + a.toString());
                    ...
                    h;
                                                ...
                                                } else 3 === a.nodeType ? b += a.nodeValue : 4 ===
                    a.nodeType && (b += "<![CDATA[" + a.nodeValue + "]]\x3e");
                                                return b
                                                            ...
                                                            drag: function (a) {
                                                                return b.extend({
                                                                    start: function (e, d) {
                                                                        ...
                                                                        for (f = 0; f < b.data(c, "dnd").connectWith.length; f++) b(b.data(c,
                                            "dnd").connectWith[f]).jqGrid("getGridParam", "reccount") == "0" && b(b.data(c, "dnd").connectWith[f]).jqGrid("addRowData", "jqg_empty_row", {});
                                                                    ...
                                                                    stop: function (e, d) {
                                                                        ...
                                                                        for (f = 0; f < b.data(c, "dnd").connectWith.length; f++) b(b.data(c,
                                            "dnd").connectWith[f]).jqGrid("delRowData", "jqg_empty_row");
                                                ...
                                                f = d.draggable.parent().parent().jqGrid("getRowData", f);
                                                    ...
                                                    j = {}, h, l, p = b("#" + b.jgrid.jqID(this.id)).jqGrid("getGridParam", "colModel");
                                                                            ...
                                                                            if (d.helper.dropped) {
                                                                                var k;
                                                                                if (a.autoid)
                                                                                    if (b.isFunction(a.autoid)) k = a.autoid.call(this, f);
                                                                                    else {
                    ...
                    c = b.jgrid.jqID(d.p.id);
                        ...
                        a || {});
                                                    if (a.alsoResize) {
                                                        ...
                                                        delete a.alsoResize
                                                    } else a._alsoResize_ = false; if (a.stop && b.isFunction(a.stop)) {
                                                        a._stop_ = a.stop;
                                                        delete a.stop
                                                    } else a._stop_ = false;
                                                    a.stop = function (e, g) {
